...
| `snap` | `[-o FILE] [-d DEVICE] [-r WxH] [--warmup N] [--max]` | Still capture. Defaults: `IPEVO V4K`, 1920x1080@30, 15-frame warm-up, output `~/Pictures/cameraboi/snap-YYYYmmdd-HHMMSS.jpg`. `--max` tries the camera's high-res photo mode |
